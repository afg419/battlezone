...
class LevelLibrary{
  ...
  get level2(){
    ...
    var cubeGap = 100;
    var bootyWidth = 10;
    var mines = [new Mine(new Vector(1800,cubeWidth/2 + cubeGap/2, 0), 0, cubeWidth),
                new Mine(new Vector(1800,-cubeWidth/2 - cubeGap/2, 0), 0, cubeWidth),
                new Mine(new Vector(1800 + cubeWidth + cubeGap, cubeWidth/2 + cubeGap/2, 0), 0, cubeWidth),
                new Mine(new Vector(1800 + cubeWidth + cubeGap,-cubeWidth/2 - cubeGap/2, 0), 0, cubeWidth),

                // new Mine(new Vector(1800,0, 0), 0, bootyWidth),
                // new Mine(new Vector(1800+cubeWidth+cubeGap,0, cubeWidth/4), 0, bootyWidth),
                // new Mine(new Vector(1800,0, -cubeWidth/4), 0, bootyWidth),
                // new Mine(new Vector(1800+cubeWidth+cubeGap,0, -cubeWidth/4), 0, bootyWidth),
    ];
    var booty = [
      //closest
      new Booty(new Vector(1800 - cubeWidth/4, 0, 0), 17, 15, 700),
      new Booty(new Vector(1800 - bootyWidth, 0, cubeWidth/4), 17, 15, 700),
      new Booty(new Vector(1800 -bootyWidth, 0, -cubeWidth/4), 17, 15, 700),

      //furthest
      new Booty(new Vector(1800 +cubeWidth + cubeGap + cubeWidth/4, 0, 0), 17, 15, 700),
      new Booty(new Vector(1800 +cubeWidth + cubeGap + bootyWidth, 0, cubeWidth/4), 17, 15, 700),
      new Booty(new Vector(1800 +cubeWidth + cubeGap + bootyWidth, 0, -cubeWidth/4), 17, 15, 700),

      //left
      new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, cubeGap/2 + cubeWidth/2 + bootyWidth, -cubeWidth/4), 17, 15, 700),
      new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, cubeGap/2 + cubeWidth/2 + bootyWidth, cubeWidth/4), 17, 15, 700),
      new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, cubeGap/2 + 3*cubeWidth/4, 0 ), 17, 15, 700),
      ...
      // (new Booty(new Vector(1800 - cubeWidth/2, 0, 0), 17, 15, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 100, 0, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 200, 0, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 350, -cubeGap/2+bootyWidth/2, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 500, 0, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 600, cubeGap/2-bootyWidth/2, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 700, 0, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 850, -cubeGap/2+bootyWidth/2, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 1000, 0, 0), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 1150, cubeGap/2-bootyWidth/2, 0), 17, 15, 700)),
      // //z up
      // (new Booty(new Vector(1800 - cubeWidth/2, 0, 250), 17, 15, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 100, 0, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 200, 0, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 350, -cubeGap/2+bootyWidth/2, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 500, 0, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 600, cubeGap/2-bootyWidth/2, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 700, 0, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 850, -cubeGap/2+bootyWidth/2, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 1000, 0, 250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 1150, cubeGap/2-bootyWidth/2, 250), 17, 15, 700)),
      // //z down
      // (new Booty(new Vector(1800 - cubeWidth/2, 0, -250), 17, 15, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 100, 0, -250), 17, bootyWidth, 700)),
      // (new Booty(new Vector(1800 - cubeWidth/2 + 200, 0, -250), 17, bootyWidth, 700)),
      ...
      // (new Booty(new Vector(1800 - cubeWidth/2 + 1150, cubeGap/2-bootyWidth/2, -250), 17, 15, 700)),
      // //y left
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap - bootyWidth/2, -100 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + bootyWidth/2, -200 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap - bootyWidth/2, -100 , -cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + bootyWidth/2, -200 , -cubeWidth/4), 17, 15, 700)),
      //
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -350 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -500 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -600 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -700 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -850 , cubeWidth/4), 17, 15, 700)),
      // (new Booty(new Vector(1800 + cubeWidth/2 + cubeGap/2, -1000 , cubeWidth/4), 17, 15, 700)),
    ];

    var turrets = [
                    new Turret(new Vector(1800+cubeWidth/2 + cubeGap/2, 0, cubeWidth/4), 0, 30),
                    new Turret(new Vector(1800+cubeWidth/2 + cubeGap/2, 0, -cubeWidth/4), 0, 30),
                ];
